...
public class Board {
    ...
    // Effects: updates game board in accordance with changes on the previous method call
    ...
    // Requires: nothing
    // Modifies: nothing
    // Effects: returns true if pacman is caught or all food is gone
    ...
    // Modifies: nothing
    // Effects: returns true if the position is passable
